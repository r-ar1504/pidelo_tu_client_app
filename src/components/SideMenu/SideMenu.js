          ...
          <View style={style.sidebar_links}>
            <TouchableWithoutFeedback onPress={this.openPromos}>
              <View style={style.sidebar_link}>
                <FontIcon name="ticket" size={15} color="#fff" style={{marginTop: 2, paddingRight:4}} />
            ...
            <TouchableWithoutFeedback onPress={this.accountSettings.bind(this,user)}>
              <View style={style.sidebar_link}>
                <FontIcon name="cogs" size={15} color="#fff"  style={{marginTop: 2, paddingRight:3}} />
            ...
            <TouchableWithoutFeedback onPress={this.currentLocation}>
              <View style={style.sidebar_link}>
                <FontIcon name="map-marker" size={15} color="#fff"  style={{marginTop: 2, paddingRight:6, paddingLeft: 3}}/>
            ...
            <TouchableWithoutFeedback onPress={this.orderHistory}>
              <View style={style.sidebar_link}>
                <FontIcon name="list-ol" size={15} color="#fff" style={{marginTop: 2, paddingRight:4}} />
            ...
            <TouchableWithoutFeedback onPress={this.paymentMethod}>
              <View style={style.sidebar_link}>
                <Icon active name="cash" style={{marginTop: 2, paddingRight:4, fontSize: 15, color: '#fff'}} />
