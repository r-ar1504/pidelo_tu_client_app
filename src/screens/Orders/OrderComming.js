...
import { View, BackHandler, Image, ImageBackground, Alert, Dimensions } from 'react-native';
        ...
        <View style={{paddingBottom: 20}} key={order.order_id}>
          ...
          <View style={styles.deliveryProgress}>
            <View style={{flexDirection: 'row', paddingLeft: 10, paddingTop: 10}}>              
              <Text style={{marginLeft: 10, fontFamily: 'Lato-Regular', color:'#fff'}}>Pedido #{order.order_id}</Text>              
              <Icon active name='time' style={{color:'white', fontSize: 15, marginLeft: width * .350}} /><Text style={{marginLeft: 5, fontFamily: 'Lato-Regular', color:'#fff'}}>00:20:00</Text>              
            </View>
            <View style={{flexDirection: 'row', paddingLeft: 10, paddingTop: 10}}>              
              <Text style={{marginLeft: 10, fontFamily: 'Lato-Regular', color:'#fff'}}>{order.quantity}</Text>              
              <Text style={{marginLeft: 10, fontFamily: 'Lato-Regular', color:'#fff'}}>{order.name}</Text>     
            </View>
            <View style={{flexDirection: 'row', paddingLeft: 10, paddingTop: 10}}>              
              <Text style={{marginLeft: 10, fontFamily: 'Lato-Regular', color:'#fff', fontSize: 12, flex: 1, flexWrap:'wrap'}}>{order.description}</Text>                            
            </View>
            <View style={{flexDirection: 'row', paddingLeft: 10, paddingTop: 10}}>              
            ...
            <View style={{flexDirection: 'row', paddingLeft: 10, paddingTop: 10}}>              
              ...
              <Text style={{marginLeft: 5, fontFamily: 'Lato-Regular', color:'#fff', flex: 1, flexWrap: 'wrap'}}>Tu entrega por Jose Fernando</Text>                                            
