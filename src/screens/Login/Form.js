  ...
  render() {
    ...
    return (
      <Content scrollEnabled={false}>
        ...
        <TouchableOpacity style={styles.button} onPress={this.signIn.bind(this, email, password)}>
          <Text style={styles.buttonText}>INGRESAR</Text>
        </TouchableOpacity>
        <Item style={styles.signupTextCont}>
          <TouchableOpacity onPress={this.props.fblogin}><Text style={styles.fb}><Icon active name={'logo-facebook'} style={{ color: 'white', fontSize: 18 }} /> FACEBOOK</Text></TouchableOpacity>
          <TouchableOpacity onPress={this.props.register}><Text style={styles.movil}><Icon active name={'phone-portrait'} style={{ color: 'white', fontSize: 18 }} /> MOVIL</Text></TouchableOpacity>
        </Item>
        <Footer style={{backgroundColor:'#00000000', flexDirection:'row', justifyContent:'center'}}>            
          {/* <TouchableOpacity onPress={this.props.signup}><Text style={styles.signupButton}> Crear cuenta</Text></TouchableOpacity>                         */}
          {/* <TouchableOpacity onPress={this.props.passwordReset}><Text style={styles.forgotpassButton}> ¿Olvidaste tu contraseña?</Text></TouchableOpacity>                                 */}
        </Footer>
      </Content>
    )
  }
